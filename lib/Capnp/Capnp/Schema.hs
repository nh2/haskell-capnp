...
instance C'.IsPtr msg (B'.List msg (Annotation msg)) where
    ...
    toPtr msg (List_Annotation l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "value" (H'.Has (Annotation msg -> m Bool)) where
    fromLabel = H'.Has $ has_Annotation'value
...
instance U'.ReadCtx m msg => IsLabel "brand" (H'.Has (Annotation msg -> m Bool)) where
    fromLabel = H'.Has $ has_Annotation'brand
...
instance C'.IsPtr msg (B'.List msg (Brand msg)) where
    ...
    toPtr msg (List_Brand l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "scopes" (H'.Has (Brand msg -> m Bool)) where
    fromLabel = H'.Has $ has_Brand'scopes
...
instance C'.IsPtr msg (B'.List msg (CapnpVersion msg)) where
    ...
    toPtr msg (List_CapnpVersion l) = C'.toPtr msg l
...
instance C'.IsPtr msg (B'.List msg (CodeGeneratorRequest msg)) where
    ...
    toPtr msg (List_CodeGeneratorRequest l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "nodes" (H'.Has (CodeGeneratorRequest msg -> m Bool)) where
    fromLabel = H'.Has $ has_CodeGeneratorRequest'nodes
...
instance U'.ReadCtx m msg => IsLabel "requestedFiles" (H'.Has (CodeGeneratorRequest msg -> m Bool)) where
    fromLabel = H'.Has $ has_CodeGeneratorRequest'requestedFiles
...
instance U'.ReadCtx m msg => IsLabel "capnpVersion" (H'.Has (CodeGeneratorRequest msg -> m Bool)) where
    fromLabel = H'.Has $ has_CodeGeneratorRequest'capnpVersion
...
instance C'.IsPtr msg (B'.List msg ElementSize) where
    ...
    toPtr msg (List_ElementSize l) = C'.toPtr msg l
...
instance C'.IsPtr msg (B'.List msg (Enumerant msg)) where
    ...
    toPtr msg (List_Enumerant l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "name" (H'.Has (Enumerant msg -> m Bool)) where
    fromLabel = H'.Has $ has_Enumerant'name
...
instance U'.ReadCtx m msg => IsLabel "annotations" (H'.Has (Enumerant msg -> m Bool)) where
    fromLabel = H'.Has $ has_Enumerant'annotations
...
instance C'.IsPtr msg (B'.List msg (Field msg)) where
    ...
    toPtr msg (List_Field l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "name" (H'.Has (Field msg -> m Bool)) where
    fromLabel = H'.Has $ has_Field'name
...
instance U'.ReadCtx m msg => IsLabel "annotations" (H'.Has (Field msg -> m Bool)) where
    fromLabel = H'.Has $ has_Field'annotations
...
instance C'.IsPtr msg (B'.List msg (Method msg)) where
    ...
    toPtr msg (List_Method l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "name" (H'.Has (Method msg -> m Bool)) where
    fromLabel = H'.Has $ has_Method'name
...
instance U'.ReadCtx m msg => IsLabel "annotations" (H'.Has (Method msg -> m Bool)) where
    fromLabel = H'.Has $ has_Method'annotations
...
instance U'.ReadCtx m msg => IsLabel "paramBrand" (H'.Has (Method msg -> m Bool)) where
    fromLabel = H'.Has $ has_Method'paramBrand
...
instance U'.ReadCtx m msg => IsLabel "resultBrand" (H'.Has (Method msg -> m Bool)) where
    fromLabel = H'.Has $ has_Method'resultBrand
...
instance U'.ReadCtx m msg => IsLabel "implicitParameters" (H'.Has (Method msg -> m Bool)) where
    fromLabel = H'.Has $ has_Method'implicitParameters
...
instance C'.IsPtr msg (B'.List msg (Node msg)) where
    ...
    toPtr msg (List_Node l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "displayName" (H'.Has (Node msg -> m Bool)) where
    fromLabel = H'.Has $ has_Node'displayName
...
instance U'.ReadCtx m msg => IsLabel "nestedNodes" (H'.Has (Node msg -> m Bool)) where
    fromLabel = H'.Has $ has_Node'nestedNodes
...
instance U'.ReadCtx m msg => IsLabel "annotations" (H'.Has (Node msg -> m Bool)) where
    fromLabel = H'.Has $ has_Node'annotations
...
instance U'.ReadCtx m msg => IsLabel "parameters" (H'.Has (Node msg -> m Bool)) where
    fromLabel = H'.Has $ has_Node'parameters
...
instance C'.IsPtr msg (B'.List msg (Superclass msg)) where
    ...
    toPtr msg (List_Superclass l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "brand" (H'.Has (Superclass msg -> m Bool)) where
    fromLabel = H'.Has $ has_Superclass'brand
...
instance C'.IsPtr msg (B'.List msg (Type msg)) where
    ...
    toPtr msg (List_Type l) = C'.toPtr msg l
data Type' msg
    = Type'void
    | Type'bool
    | Type'int8
...
instance U'.ReadCtx m msg => IsLabel "elementType" (H'.Has (Type'list'group' msg -> m Bool)) where
    fromLabel = H'.Has $ has_Type'list'elementType
...
instance U'.ReadCtx m msg => IsLabel "brand" (H'.Has (Type'enum'group' msg -> m Bool)) where
    fromLabel = H'.Has $ has_Type'enum'brand
...
instance U'.ReadCtx m msg => IsLabel "brand" (H'.Has (Type'struct'group' msg -> m Bool)) where
    fromLabel = H'.Has $ has_Type'struct'brand
...
instance U'.ReadCtx m msg => IsLabel "brand" (H'.Has (Type'interface'group' msg -> m Bool)) where
    fromLabel = H'.Has $ has_Type'interface'brand
...
instance C'.IsPtr msg (B'.List msg (Value msg)) where
    ...
    toPtr msg (List_Value l) = C'.toPtr msg l
data Value' msg
    = Value'void
    | Value'bool Bool
    | Value'int8 Int8
...
instance C'.IsPtr msg (B'.List msg (Brand'Binding msg)) where
    ...
    toPtr msg (List_Brand'Binding l) = C'.toPtr msg l
...
instance C'.IsPtr msg (B'.List msg (Brand'Scope msg)) where
    ...
    toPtr msg (List_Brand'Scope l) = C'.toPtr msg l
...
instance C'.IsPtr msg (B'.List msg (CodeGeneratorRequest'RequestedFile msg)) where
    ...
    toPtr msg (List_CodeGeneratorRequest'RequestedFile l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "filename" (H'.Has (CodeGeneratorRequest'RequestedFile msg -> m Bool)) where
    fromLabel = H'.Has $ has_CodeGeneratorRequest'RequestedFile'filename
...
instance U'.ReadCtx m msg => IsLabel "imports" (H'.Has (CodeGeneratorRequest'RequestedFile msg -> m Bool)) where
    fromLabel = H'.Has $ has_CodeGeneratorRequest'RequestedFile'imports
...
instance C'.IsPtr msg (B'.List msg (CodeGeneratorRequest'RequestedFile'Import msg)) where
    ...
    toPtr msg (List_CodeGeneratorRequest'RequestedFile'Import l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "name" (H'.Has (CodeGeneratorRequest'RequestedFile'Import msg -> m Bool)) where
    fromLabel = H'.Has $ has_CodeGeneratorRequest'RequestedFile'Import'name
...
instance U'.ReadCtx m msg => IsLabel "type_" (H'.Has (Field'slot'group' msg -> m Bool)) where
    fromLabel = H'.Has $ has_Field'slot'type_
...
instance U'.ReadCtx m msg => IsLabel "defaultValue" (H'.Has (Field'slot'group' msg -> m Bool)) where
    fromLabel = H'.Has $ has_Field'slot'defaultValue
...
instance U'.ReadCtx m msg => IsLabel "fields" (H'.Has (Node'struct'group' msg -> m Bool)) where
    fromLabel = H'.Has $ has_Node'struct'fields
...
instance U'.ReadCtx m msg => IsLabel "enumerants" (H'.Has (Node'enum'group' msg -> m Bool)) where
    fromLabel = H'.Has $ has_Node'enum'enumerants
...
instance U'.ReadCtx m msg => IsLabel "methods" (H'.Has (Node'interface'group' msg -> m Bool)) where
    fromLabel = H'.Has $ has_Node'interface'methods
...
instance U'.ReadCtx m msg => IsLabel "superclasses" (H'.Has (Node'interface'group' msg -> m Bool)) where
    fromLabel = H'.Has $ has_Node'interface'superclasses
...
instance U'.ReadCtx m msg => IsLabel "type_" (H'.Has (Node'const'group' msg -> m Bool)) where
    fromLabel = H'.Has $ has_Node'const'type_
...
instance U'.ReadCtx m msg => IsLabel "value" (H'.Has (Node'const'group' msg -> m Bool)) where
    fromLabel = H'.Has $ has_Node'const'value
...
instance U'.ReadCtx m msg => IsLabel "type_" (H'.Has (Node'annotation'group' msg -> m Bool)) where
    fromLabel = H'.Has $ has_Node'annotation'type_
...
instance C'.IsPtr msg (B'.List msg (Node'NestedNode msg)) where
    ...
    toPtr msg (List_Node'NestedNode l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "name" (H'.Has (Node'NestedNode msg -> m Bool)) where
    fromLabel = H'.Has $ has_Node'NestedNode'name
...
instance C'.IsPtr msg (B'.List msg (Node'Parameter msg)) where
    ...
    toPtr msg (List_Node'Parameter l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "name" (H'.Has (Node'Parameter msg -> m Bool)) where
    fromLabel = H'.Has $ has_Node'Parameter'name
