...
get_RealmGateway'export'params'cap (RealmGateway'export'params_newtype_ struct) =
    U'.getPtr 0 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "cap" (H'.Get (RealmGateway'export'params msg -> m (Persistent msg))) where
    fromLabel = H'.Get $ get_RealmGateway'export'params'cap
...
instance U'.ReadCtx m msg => IsLabel "cap" (H'.Has (RealmGateway'export'params msg -> m Bool)) where
    fromLabel = H'.Has $ has_RealmGateway'export'params'cap
...
get_RealmGateway'export'params'params (RealmGateway'export'params_newtype_ struct) =
    U'.getPtr 1 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "params" (H'.Get (RealmGateway'export'params msg -> m (Persistent'SaveParams msg))) where
    fromLabel = H'.Get $ get_RealmGateway'export'params'params
...
instance U'.ReadCtx m msg => IsLabel "params" (H'.Has (RealmGateway'export'params msg -> m Bool)) where
    fromLabel = H'.Has $ has_RealmGateway'export'params'params
...
get_RealmGateway'import'params'cap (RealmGateway'import'params_newtype_ struct) =
    U'.getPtr 0 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "cap" (H'.Get (RealmGateway'import'params msg -> m (Persistent msg))) where
    fromLabel = H'.Get $ get_RealmGateway'import'params'cap
...
instance U'.ReadCtx m msg => IsLabel "cap" (H'.Has (RealmGateway'import'params msg -> m Bool)) where
    fromLabel = H'.Has $ has_RealmGateway'import'params'cap
...
get_RealmGateway'import'params'params (RealmGateway'import'params_newtype_ struct) =
    U'.getPtr 1 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "params" (H'.Get (RealmGateway'import'params msg -> m (Persistent'SaveParams msg))) where
    fromLabel = H'.Get $ get_RealmGateway'import'params'params
...
instance U'.ReadCtx m msg => IsLabel "params" (H'.Has (RealmGateway'import'params msg -> m Bool)) where
    fromLabel = H'.Has $ has_RealmGateway'import'params'params
