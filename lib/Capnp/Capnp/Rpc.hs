...
instance C'.IsPtr msg (B'.List msg (Accept msg)) where
    ...
    toPtr msg (List_Accept l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "questionId" (H'.Get (Accept msg -> m Word32)) where
    fromLabel = H'.Get $ get_Accept'questionId
...
instance U'.RWCtx m s => IsLabel "questionId" (H'.Set (Accept (M'.MutMsg s) -> Word32 -> m ())) where
    fromLabel = H'.Set set_Accept'questionId
get_Accept'provision :: U'.ReadCtx m msg => Accept msg -> m (Maybe (U'.Ptr msg))
get_Accept'provision (Accept_newtype_ struct) =
    U'.getPtr 0 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "provision" (H'.Get (Accept msg -> m (Maybe (U'.Ptr msg)))) where
    fromLabel = H'.Get $ get_Accept'provision
...
instance U'.ReadCtx m msg => IsLabel "provision" (H'.Has (Accept msg -> m Bool)) where
    fromLabel = H'.Has $ has_Accept'provision
...
instance U'.RWCtx m s => IsLabel "provision" (H'.Set (Accept (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ())) where
    fromLabel = H'.Set set_Accept'provision
...
instance U'.ReadCtx m msg => IsLabel "embargo" (H'.Get (Accept msg -> m Bool)) where
    fromLabel = H'.Get $ get_Accept'embargo
...
instance U'.RWCtx m s => IsLabel "embargo" (H'.Set (Accept (M'.MutMsg s) -> Bool -> m ())) where
    fromLabel = H'.Set set_Accept'embargo
...
instance C'.IsPtr msg (B'.List msg (Bootstrap msg)) where
    ...
    toPtr msg (List_Bootstrap l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "questionId" (H'.Get (Bootstrap msg -> m Word32)) where
    fromLabel = H'.Get $ get_Bootstrap'questionId
...
instance U'.RWCtx m s => IsLabel "questionId" (H'.Set (Bootstrap (M'.MutMsg s) -> Word32 -> m ())) where
    fromLabel = H'.Set set_Bootstrap'questionId
...
get_Bootstrap'deprecatedObjectId (Bootstrap_newtype_ struct) =
    U'.getPtr 0 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "deprecatedObjectId" (H'.Get (Bootstrap msg -> m (Maybe (U'.Ptr msg)))) where
    fromLabel = H'.Get $ get_Bootstrap'deprecatedObjectId
...
instance U'.ReadCtx m msg => IsLabel "deprecatedObjectId" (H'.Has (Bootstrap msg -> m Bool)) where
    fromLabel = H'.Has $ has_Bootstrap'deprecatedObjectId
...
set_Bootstrap'deprecatedObjectId (Bootstrap_newtype_ struct) value = do
    ptr <- C'.toPtr (U'.message struct) value
    U'.setPtr ptr 0 struct
instance U'.RWCtx m s => IsLabel "deprecatedObjectId" (H'.Set (Bootstrap (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ())) where
    fromLabel = H'.Set set_Bootstrap'deprecatedObjectId
...
instance C'.IsPtr msg (B'.List msg (Call msg)) where
    ...
    toPtr msg (List_Call l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "questionId" (H'.Get (Call msg -> m Word32)) where
    fromLabel = H'.Get $ get_Call'questionId
...
instance U'.RWCtx m s => IsLabel "questionId" (H'.Set (Call (M'.MutMsg s) -> Word32 -> m ())) where
    fromLabel = H'.Set set_Call'questionId
get_Call'target :: U'.ReadCtx m msg => Call msg -> m (MessageTarget msg)
get_Call'target (Call_newtype_ struct) =
    U'.getPtr 0 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "target" (H'.Get (Call msg -> m (MessageTarget msg))) where
    fromLabel = H'.Get $ get_Call'target
has_Call'target :: U'.ReadCtx m msg => Call msg -> m Bool
has_Call'target(Call_newtype_ struct) = Data.Maybe.isJust <$> U'.getPtr 0 struct
instance U'.ReadCtx m msg => IsLabel "target" (H'.Has (Call msg -> m Bool)) where
    fromLabel = H'.Has $ has_Call'target
set_Call'target :: U'.RWCtx m s => Call (M'.MutMsg s) -> (MessageTarget (M'.MutMsg s)) -> m ()
set_Call'target (Call_newtype_ struct) value = do
    ptr <- C'.toPtr (U'.message struct) value
    U'.setPtr ptr 0 struct
instance U'.RWCtx m s => IsLabel "target" (H'.Set (Call (M'.MutMsg s) -> (MessageTarget (M'.MutMsg s)) -> m ())) where
    fromLabel = H'.Set set_Call'target
...
instance U'.ReadCtx m msg => IsLabel "interfaceId" (H'.Get (Call msg -> m Word64)) where
    fromLabel = H'.Get $ get_Call'interfaceId
...
instance U'.RWCtx m s => IsLabel "interfaceId" (H'.Set (Call (M'.MutMsg s) -> Word64 -> m ())) where
    fromLabel = H'.Set set_Call'interfaceId
get_Call'methodId :: U'.ReadCtx m msg => Call msg -> m Word16
get_Call'methodId (Call_newtype_ struct) = H'.getWordField struct 0 32 0
instance U'.ReadCtx m msg => IsLabel "methodId" (H'.Get (Call msg -> m Word16)) where
    fromLabel = H'.Get $ get_Call'methodId
...
instance U'.RWCtx m s => IsLabel "methodId" (H'.Set (Call (M'.MutMsg s) -> Word16 -> m ())) where
    fromLabel = H'.Set set_Call'methodId
get_Call'params :: U'.ReadCtx m msg => Call msg -> m (Payload msg)
get_Call'params (Call_newtype_ struct) =
    U'.getPtr 1 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "params" (H'.Get (Call msg -> m (Payload msg))) where
    fromLabel = H'.Get $ get_Call'params
has_Call'params :: U'.ReadCtx m msg => Call msg -> m Bool
has_Call'params(Call_newtype_ struct) = Data.Maybe.isJust <$> U'.getPtr 1 struct
instance U'.ReadCtx m msg => IsLabel "params" (H'.Has (Call msg -> m Bool)) where
    fromLabel = H'.Has $ has_Call'params
...
instance U'.RWCtx m s => IsLabel "params" (H'.Set (Call (M'.MutMsg s) -> (Payload (M'.MutMsg s)) -> m ())) where
    fromLabel = H'.Set set_Call'params
...
instance U'.ReadCtx m msg => IsLabel "sendResultsTo" (H'.Get (Call msg -> m (Call'sendResultsTo msg))) where
    fromLabel = H'.Get $ get_Call'sendResultsTo
...
instance U'.ReadCtx m msg => IsLabel "allowThirdPartyTailCall" (H'.Get (Call msg -> m Bool)) where
    fromLabel = H'.Get $ get_Call'allowThirdPartyTailCall
...
instance U'.RWCtx m s => IsLabel "allowThirdPartyTailCall" (H'.Set (Call (M'.MutMsg s) -> Bool -> m ())) where
    fromLabel = H'.Set set_Call'allowThirdPartyTailCall
...
instance C'.IsPtr msg (B'.List msg (CapDescriptor msg)) where
    ...
    toPtr msg (List_CapDescriptor l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "" (H'.Get (CapDescriptor msg -> m (CapDescriptor' msg))) where
    fromLabel = H'.Get $ get_CapDescriptor'
...
instance C'.IsPtr msg (B'.List msg (Disembargo msg)) where
    ...
    toPtr msg (List_Disembargo l) = C'.toPtr msg l
get_Disembargo'target :: U'.ReadCtx m msg => Disembargo msg -> m (MessageTarget msg)
get_Disembargo'target (Disembargo_newtype_ struct) =
    U'.getPtr 0 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "target" (H'.Get (Disembargo msg -> m (MessageTarget msg))) where
    fromLabel = H'.Get $ get_Disembargo'target
...
instance U'.ReadCtx m msg => IsLabel "target" (H'.Has (Disembargo msg -> m Bool)) where
    fromLabel = H'.Has $ has_Disembargo'target
...
set_Disembargo'target (Disembargo_newtype_ struct) value = do
    ptr <- C'.toPtr (U'.message struct) value
    U'.setPtr ptr 0 struct
instance U'.RWCtx m s => IsLabel "target" (H'.Set (Disembargo (M'.MutMsg s) -> (MessageTarget (M'.MutMsg s)) -> m ())) where
    fromLabel = H'.Set set_Disembargo'target
...
instance U'.ReadCtx m msg => IsLabel "context" (H'.Get (Disembargo msg -> m (Disembargo'context msg))) where
    fromLabel = H'.Get $ get_Disembargo'context
...
instance C'.IsPtr msg (B'.List msg (Exception msg)) where
    ...
    toPtr msg (List_Exception l) = C'.toPtr msg l
get_Exception'reason :: U'.ReadCtx m msg => Exception msg -> m (B'.Text msg)
get_Exception'reason (Exception_newtype_ struct) =
    U'.getPtr 0 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "reason" (H'.Get (Exception msg -> m (B'.Text msg))) where
    fromLabel = H'.Get $ get_Exception'reason
...
instance U'.ReadCtx m msg => IsLabel "reason" (H'.Has (Exception msg -> m Bool)) where
    fromLabel = H'.Has $ has_Exception'reason
...
set_Exception'reason (Exception_newtype_ struct) value = do
    ptr <- C'.toPtr (U'.message struct) value
    U'.setPtr ptr 0 struct
instance U'.RWCtx m s => IsLabel "reason" (H'.Set (Exception (M'.MutMsg s) -> (B'.Text (M'.MutMsg s)) -> m ())) where
    fromLabel = H'.Set set_Exception'reason
...
instance U'.ReadCtx m msg => IsLabel "obsoleteIsCallersFault" (H'.Get (Exception msg -> m Bool)) where
    fromLabel = H'.Get $ get_Exception'obsoleteIsCallersFault
...
instance U'.RWCtx m s => IsLabel "obsoleteIsCallersFault" (H'.Set (Exception (M'.MutMsg s) -> Bool -> m ())) where
    fromLabel = H'.Set set_Exception'obsoleteIsCallersFault
...
instance U'.ReadCtx m msg => IsLabel "obsoleteDurability" (H'.Get (Exception msg -> m Word16)) where
    fromLabel = H'.Get $ get_Exception'obsoleteDurability
...
instance U'.RWCtx m s => IsLabel "obsoleteDurability" (H'.Set (Exception (M'.MutMsg s) -> Word16 -> m ())) where
    fromLabel = H'.Set set_Exception'obsoleteDurability
...
instance U'.ReadCtx m msg => IsLabel "type_" (H'.Get (Exception msg -> m Exception'Type)) where
    fromLabel = H'.Get $ get_Exception'type_
...
instance U'.RWCtx m s => IsLabel "type_" (H'.Set (Exception (M'.MutMsg s) -> Exception'Type -> m ())) where
    fromLabel = H'.Set set_Exception'type_
...
instance C'.IsPtr msg (B'.List msg (Finish msg)) where
    ...
    toPtr msg (List_Finish l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "questionId" (H'.Get (Finish msg -> m Word32)) where
    fromLabel = H'.Get $ get_Finish'questionId
...
instance U'.RWCtx m s => IsLabel "questionId" (H'.Set (Finish (M'.MutMsg s) -> Word32 -> m ())) where
    fromLabel = H'.Set set_Finish'questionId
...
instance U'.ReadCtx m msg => IsLabel "releaseResultCaps" (H'.Get (Finish msg -> m Bool)) where
    fromLabel = H'.Get $ get_Finish'releaseResultCaps
...
instance U'.RWCtx m s => IsLabel "releaseResultCaps" (H'.Set (Finish (M'.MutMsg s) -> Bool -> m ())) where
    fromLabel = H'.Set set_Finish'releaseResultCaps
...
instance C'.IsPtr msg (B'.List msg (Join msg)) where
    ...
    toPtr msg (List_Join l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "questionId" (H'.Get (Join msg -> m Word32)) where
    fromLabel = H'.Get $ get_Join'questionId
...
instance U'.RWCtx m s => IsLabel "questionId" (H'.Set (Join (M'.MutMsg s) -> Word32 -> m ())) where
    fromLabel = H'.Set set_Join'questionId
get_Join'target :: U'.ReadCtx m msg => Join msg -> m (MessageTarget msg)
get_Join'target (Join_newtype_ struct) =
    U'.getPtr 0 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "target" (H'.Get (Join msg -> m (MessageTarget msg))) where
    fromLabel = H'.Get $ get_Join'target
has_Join'target :: U'.ReadCtx m msg => Join msg -> m Bool
has_Join'target(Join_newtype_ struct) = Data.Maybe.isJust <$> U'.getPtr 0 struct
instance U'.ReadCtx m msg => IsLabel "target" (H'.Has (Join msg -> m Bool)) where
    fromLabel = H'.Has $ has_Join'target
set_Join'target :: U'.RWCtx m s => Join (M'.MutMsg s) -> (MessageTarget (M'.MutMsg s)) -> m ()
set_Join'target (Join_newtype_ struct) value = do
    ptr <- C'.toPtr (U'.message struct) value
    U'.setPtr ptr 0 struct
instance U'.RWCtx m s => IsLabel "target" (H'.Set (Join (M'.MutMsg s) -> (MessageTarget (M'.MutMsg s)) -> m ())) where
    fromLabel = H'.Set set_Join'target
...
get_Join'keyPart (Join_newtype_ struct) =
    U'.getPtr 1 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "keyPart" (H'.Get (Join msg -> m (Maybe (U'.Ptr msg)))) where
    fromLabel = H'.Get $ get_Join'keyPart
...
instance U'.ReadCtx m msg => IsLabel "keyPart" (H'.Has (Join msg -> m Bool)) where
    fromLabel = H'.Has $ has_Join'keyPart
set_Join'keyPart :: U'.RWCtx m s => Join (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ()
set_Join'keyPart (Join_newtype_ struct) value = do
    ptr <- C'.toPtr (U'.message struct) value
    U'.setPtr ptr 1 struct
instance U'.RWCtx m s => IsLabel "keyPart" (H'.Set (Join (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ())) where
    fromLabel = H'.Set set_Join'keyPart
...
instance C'.IsPtr msg (B'.List msg (Message msg)) where
    ...
    toPtr msg (List_Message l) = C'.toPtr msg l
data Message' msg
...
instance U'.ReadCtx m msg => IsLabel "" (H'.Get (Message msg -> m (Message' msg))) where
    fromLabel = H'.Get $ get_Message'
...
instance C'.IsPtr msg (B'.List msg (MessageTarget msg)) where
    ...
    toPtr msg (List_MessageTarget l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "" (H'.Get (MessageTarget msg -> m (MessageTarget' msg))) where
    fromLabel = H'.Get $ get_MessageTarget'
...
instance C'.IsPtr msg (B'.List msg (Payload msg)) where
    ...
    toPtr msg (List_Payload l) = C'.toPtr msg l
get_Payload'content :: U'.ReadCtx m msg => Payload msg -> m (Maybe (U'.Ptr msg))
get_Payload'content (Payload_newtype_ struct) =
    U'.getPtr 0 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "content" (H'.Get (Payload msg -> m (Maybe (U'.Ptr msg)))) where
    fromLabel = H'.Get $ get_Payload'content
...
instance U'.ReadCtx m msg => IsLabel "content" (H'.Has (Payload msg -> m Bool)) where
    fromLabel = H'.Has $ has_Payload'content
...
set_Payload'content (Payload_newtype_ struct) value = do
    ptr <- C'.toPtr (U'.message struct) value
    U'.setPtr ptr 0 struct
instance U'.RWCtx m s => IsLabel "content" (H'.Set (Payload (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ())) where
    fromLabel = H'.Set set_Payload'content
...
get_Payload'capTable (Payload_newtype_ struct) =
    U'.getPtr 1 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "capTable" (H'.Get (Payload msg -> m (B'.List msg (CapDescriptor msg)))) where
    fromLabel = H'.Get $ get_Payload'capTable
...
instance U'.ReadCtx m msg => IsLabel "capTable" (H'.Has (Payload msg -> m Bool)) where
    fromLabel = H'.Has $ has_Payload'capTable
...
set_Payload'capTable (Payload_newtype_ struct) value = do
    ptr <- C'.toPtr (U'.message struct) value
    U'.setPtr ptr 1 struct
instance U'.RWCtx m s => IsLabel "capTable" (H'.Set (Payload (M'.MutMsg s) -> (B'.List (M'.MutMsg s) (CapDescriptor (M'.MutMsg s))) -> m ())) where
    fromLabel = H'.Set set_Payload'capTable
...
instance C'.IsPtr msg (B'.List msg (PromisedAnswer msg)) where
    ...
    toPtr msg (List_PromisedAnswer l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "questionId" (H'.Get (PromisedAnswer msg -> m Word32)) where
    fromLabel = H'.Get $ get_PromisedAnswer'questionId
...
instance U'.RWCtx m s => IsLabel "questionId" (H'.Set (PromisedAnswer (M'.MutMsg s) -> Word32 -> m ())) where
    fromLabel = H'.Set set_PromisedAnswer'questionId
...
get_PromisedAnswer'transform (PromisedAnswer_newtype_ struct) =
    U'.getPtr 0 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "transform" (H'.Get (PromisedAnswer msg -> m (B'.List msg (PromisedAnswer'Op msg)))) where
    fromLabel = H'.Get $ get_PromisedAnswer'transform
...
instance U'.ReadCtx m msg => IsLabel "transform" (H'.Has (PromisedAnswer msg -> m Bool)) where
    fromLabel = H'.Has $ has_PromisedAnswer'transform
...
set_PromisedAnswer'transform (PromisedAnswer_newtype_ struct) value = do
    ptr <- C'.toPtr (U'.message struct) value
    U'.setPtr ptr 0 struct
instance U'.RWCtx m s => IsLabel "transform" (H'.Set (PromisedAnswer (M'.MutMsg s) -> (B'.List (M'.MutMsg s) (PromisedAnswer'Op (M'.MutMsg s))) -> m ())) where
    fromLabel = H'.Set set_PromisedAnswer'transform
...
instance C'.IsPtr msg (B'.List msg (Provide msg)) where
    ...
    toPtr msg (List_Provide l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "questionId" (H'.Get (Provide msg -> m Word32)) where
    fromLabel = H'.Get $ get_Provide'questionId
...
instance U'.RWCtx m s => IsLabel "questionId" (H'.Set (Provide (M'.MutMsg s) -> Word32 -> m ())) where
    fromLabel = H'.Set set_Provide'questionId
get_Provide'target :: U'.ReadCtx m msg => Provide msg -> m (MessageTarget msg)
get_Provide'target (Provide_newtype_ struct) =
    U'.getPtr 0 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "target" (H'.Get (Provide msg -> m (MessageTarget msg))) where
    fromLabel = H'.Get $ get_Provide'target
...
instance U'.ReadCtx m msg => IsLabel "target" (H'.Has (Provide msg -> m Bool)) where
    fromLabel = H'.Has $ has_Provide'target
...
set_Provide'target (Provide_newtype_ struct) value = do
    ptr <- C'.toPtr (U'.message struct) value
    U'.setPtr ptr 0 struct
instance U'.RWCtx m s => IsLabel "target" (H'.Set (Provide (M'.MutMsg s) -> (MessageTarget (M'.MutMsg s)) -> m ())) where
    fromLabel = H'.Set set_Provide'target
...
get_Provide'recipient (Provide_newtype_ struct) =
    U'.getPtr 1 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "recipient" (H'.Get (Provide msg -> m (Maybe (U'.Ptr msg)))) where
    fromLabel = H'.Get $ get_Provide'recipient
...
instance U'.ReadCtx m msg => IsLabel "recipient" (H'.Has (Provide msg -> m Bool)) where
    fromLabel = H'.Has $ has_Provide'recipient
...
set_Provide'recipient (Provide_newtype_ struct) value = do
    ptr <- C'.toPtr (U'.message struct) value
    U'.setPtr ptr 1 struct
instance U'.RWCtx m s => IsLabel "recipient" (H'.Set (Provide (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ())) where
    fromLabel = H'.Set set_Provide'recipient
...
instance C'.IsPtr msg (B'.List msg (Release msg)) where
    ...
    toPtr msg (List_Release l) = C'.toPtr msg l
get_Release'id :: U'.ReadCtx m msg => Release msg -> m Word32
get_Release'id (Release_newtype_ struct) = H'.getWordField struct 0 0 0
instance U'.ReadCtx m msg => IsLabel "id" (H'.Get (Release msg -> m Word32)) where
    fromLabel = H'.Get $ get_Release'id
...
instance U'.RWCtx m s => IsLabel "id" (H'.Set (Release (M'.MutMsg s) -> Word32 -> m ())) where
    fromLabel = H'.Set set_Release'id
...
instance U'.ReadCtx m msg => IsLabel "referenceCount" (H'.Get (Release msg -> m Word32)) where
    fromLabel = H'.Get $ get_Release'referenceCount
...
instance U'.RWCtx m s => IsLabel "referenceCount" (H'.Set (Release (M'.MutMsg s) -> Word32 -> m ())) where
    fromLabel = H'.Set set_Release'referenceCount
...
instance C'.IsPtr msg (B'.List msg (Resolve msg)) where
    ...
    toPtr msg (List_Resolve l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "promiseId" (H'.Get (Resolve msg -> m Word32)) where
    fromLabel = H'.Get $ get_Resolve'promiseId
...
instance U'.RWCtx m s => IsLabel "promiseId" (H'.Set (Resolve (M'.MutMsg s) -> Word32 -> m ())) where
    fromLabel = H'.Set set_Resolve'promiseId
get_Resolve'union' :: U'.ReadCtx m msg => Resolve msg -> m (Resolve' msg)
get_Resolve'union' (Resolve_newtype_ struct) = C'.fromStruct struct
instance U'.ReadCtx m msg => IsLabel "union'" (H'.Get (Resolve msg -> m (Resolve' msg))) where
    fromLabel = H'.Get $ get_Resolve'union'
...
instance C'.IsPtr msg (B'.List msg (Return msg)) where
    ...
    toPtr msg (List_Return l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "answerId" (H'.Get (Return msg -> m Word32)) where
    fromLabel = H'.Get $ get_Return'answerId
...
instance U'.RWCtx m s => IsLabel "answerId" (H'.Set (Return (M'.MutMsg s) -> Word32 -> m ())) where
    fromLabel = H'.Set set_Return'answerId
...
instance U'.ReadCtx m msg => IsLabel "releaseParamCaps" (H'.Get (Return msg -> m Bool)) where
    fromLabel = H'.Get $ get_Return'releaseParamCaps
...
instance U'.RWCtx m s => IsLabel "releaseParamCaps" (H'.Set (Return (M'.MutMsg s) -> Bool -> m ())) where
    fromLabel = H'.Set set_Return'releaseParamCaps
get_Return'union' :: U'.ReadCtx m msg => Return msg -> m (Return' msg)
get_Return'union' (Return_newtype_ struct) = C'.fromStruct struct
instance U'.ReadCtx m msg => IsLabel "union'" (H'.Get (Return msg -> m (Return' msg))) where
    fromLabel = H'.Get $ get_Return'union'
...
instance C'.IsPtr msg (B'.List msg (ThirdPartyCapDescriptor msg)) where
    ...
    toPtr msg (List_ThirdPartyCapDescriptor l) = C'.toPtr msg l
...
get_ThirdPartyCapDescriptor'id (ThirdPartyCapDescriptor_newtype_ struct) =
    U'.getPtr 0 struct
    >>= C'.fromPtr (U'.message struct)
instance U'.ReadCtx m msg => IsLabel "id" (H'.Get (ThirdPartyCapDescriptor msg -> m (Maybe (U'.Ptr msg)))) where
    fromLabel = H'.Get $ get_ThirdPartyCapDescriptor'id
...
instance U'.ReadCtx m msg => IsLabel "id" (H'.Has (ThirdPartyCapDescriptor msg -> m Bool)) where
    fromLabel = H'.Has $ has_ThirdPartyCapDescriptor'id
...
set_ThirdPartyCapDescriptor'id (ThirdPartyCapDescriptor_newtype_ struct) value = do
    ptr <- C'.toPtr (U'.message struct) value
    U'.setPtr ptr 0 struct
instance U'.RWCtx m s => IsLabel "id" (H'.Set (ThirdPartyCapDescriptor (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ())) where
    fromLabel = H'.Set set_ThirdPartyCapDescriptor'id
...
instance U'.ReadCtx m msg => IsLabel "vineId" (H'.Get (ThirdPartyCapDescriptor msg -> m Word32)) where
    fromLabel = H'.Get $ get_ThirdPartyCapDescriptor'vineId
...
instance U'.RWCtx m s => IsLabel "vineId" (H'.Set (ThirdPartyCapDescriptor (M'.MutMsg s) -> Word32 -> m ())) where
    fromLabel = H'.Set set_ThirdPartyCapDescriptor'vineId
...
instance U'.ReadCtx m msg => IsLabel "" (H'.Get (Call'sendResultsTo msg -> m (Call'sendResultsTo' msg))) where
    fromLabel = H'.Get $ get_Call'sendResultsTo'
...
instance U'.ReadCtx m msg => IsLabel "" (H'.Get (Disembargo'context msg -> m (Disembargo'context' msg))) where
    fromLabel = H'.Get $ get_Disembargo'context'
...
instance C'.IsPtr msg (B'.List msg Exception'Type) where
    ...
    toPtr msg (List_Exception'Type l) = C'.toPtr msg l
...
instance C'.IsPtr msg (B'.List msg (PromisedAnswer'Op msg)) where
    ...
    toPtr msg (List_PromisedAnswer'Op l) = C'.toPtr msg l
...
instance U'.ReadCtx m msg => IsLabel "" (H'.Get (PromisedAnswer'Op msg -> m (PromisedAnswer'Op' msg))) where
    fromLabel = H'.Get $ get_PromisedAnswer'Op'
...
instance U'.ReadCtx m msg => IsLabel "" (H'.Get (Resolve' msg -> m (Resolve'' msg))) where
    fromLabel = H'.Get $ get_Resolve''
...
instance U'.ReadCtx m msg => IsLabel "" (H'.Get (Return' msg -> m (Return'' msg))) where
    fromLabel = H'.Get $ get_Return''
